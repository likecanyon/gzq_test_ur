...
std::vector<double> GravityCompensation()
{
    ...
    std::cout << "Before Compensation in Base Frame: \n";
    for (int i = 0; i < 6; i++)
        std::cout << FS_Source[i] << " ";
    std::cout << std::endl;
    FS_Source = FromWtoS(FS_Source, R_s_w); //传到传感器坐标系下
    std::cout << "Before Compensation in Sensor Frame: \n";
    for (int i = 0; i < 6; i++)
        std::cout << FS_Source[i] << " ";
    std::cout << std::endl;
    ...
    std::cout << "After Compensation in Sensor Frame: \n";
    for (int i = 0; i < 6; i++)
    ...
    /************************************************计算完成*****************************************************/
    std::cout << "After Compensation in Base Frame : \n";
    for (int i = 0; i < 6; i++)
        std::cout << FS_AfterCompensation[i] << " ";
    std::cout << std::endl;
